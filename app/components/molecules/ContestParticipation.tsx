...
const ContestParticipation = ({ participation }: Props) => {
  ...
  return (
    <article className="md:flex md:gap-2 md:items-center sm:hover:bg-secondary/10 sm:hover:dark:bg-primary/15 transition-colors sm:rounded-md -mx-4 sm:-mx-3 my-4 px-4 sm:px-3 py-2">
