    ...
    <div className="grid gap-4 mt-10">
        <div className="-mx-4 sm:-mx-2">
            <Image
              ...
              height={768}
              alt={description}
              className="h-auto max-w-full border-y-2 sm:border-x-2 sm:rounded-md border-contrast-200/80 dark:border-contrast-700/80"
            ...
            { images.map((image, i) => (
              <div key={image.src} className="cursor-pointer" onClick={() => setSelected(i)}>
                <Image
                  ...
                  className={clsx('h-auto max-w-full rounded-sm border-contrast-200/80 dark:border-contrast-700/80', i !== selected && 'border-2')}
                />
              </div>
            )) }
        </div> }
